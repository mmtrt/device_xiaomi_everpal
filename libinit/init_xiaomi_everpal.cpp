...
static const variant_info_t evergo_cn_info = {
    ...
    .model = "21091116AC",
    .build_fingerprint = "Redmi/evergo_cn/evergo:11/RP1A.200720.011/V12.5.13.0.RGBCNXM:user/release-keys",
...
static const variant_info_t evergo_in_p_info = {
    ...
    .model = "22031116AI",
    .build_fingerprint = "POCO/evergo_p_in/evergo:11/RP1A.200720.011/V12.5.10.0.RGBINXM:user/release-keys",
...
static const variant_info_t evergreen_info = {
    ...
    .marketname = "POCO M4 Pro 5G",
    .model = "21091116AG",
    .build_fingerprint = "POCO/evergreen_global/evergreen:11/RP1A.200720.011/V12.5.9.0.RGBMIXM:user/release-keys",
...
static const variant_info_t opal_info = {
    ...
    .model = "22031116BG",
    .build_fingerprint = "Redmi/opal_global/opal:11/RP1A.200720.011/V12.5.9.0.SGLMIXM:user/release-keys",
