...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.evergo.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.evergo.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.evergo
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.evergo.rc \
    android.hardware.wifi@1.0-service.evergo.xml
